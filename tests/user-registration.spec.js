...
test.describe("User registration", ()=> {
    ...
    test.describe("Successful user registration", ()=> {
        ...
        test('Check that name field is required', async ()=> {
            ...
            await expect(signUpPopup.nameInputErrorMessage).toHaveText(signUpPopup.nameRequiredMessage)
            await expect(signUpPopup.nameInputErrorMessage).toBeVisible()
        })
        test('Check that name can not be less than 2 characters', async ()=> {
            ...
            await expect(signUpPopup.repeatPasswordInput).not.toHaveClass(/is-invalid/)
            await expect(signUpPopup.repeatPasswordInput).not.toHaveCSS('border-color', signUpPopup.invalidInputBorderColor)
            await expect(signUpPopup.nameInputErrorMessage).toHaveText(signUpPopup.nameWrongLengthMessage)
            await expect(signUpPopup.nameInputErrorMessage).toBeVisible()
        })
        ...
        test('Check that name can not have spaces', async ()=> {
            ...
            await expect(signUpPopup.repeatPasswordInput).not.toHaveClass(/is-invalid/)
            await expect(signUpPopup.repeatPasswordInput).not.toHaveCSS('border-color', signUpPopup.invalidInputBorderColor)
            await expect(signUpPopup.nameInputErrorMessage).toHaveText(signUpPopup.nameInvalidMessage)
            await expect(signUpPopup.nameInputErrorMessage).toBeVisible()
        })
        ...
        test('Check that last name field is required', async ()=> {
            ...
            await expect(signUpPopup.repeatPasswordInput).not.toHaveClass(/is-invalid/)
            await expect(signUpPopup.repeatPasswordInput).not.toHaveCSS('border-color', signUpPopup.invalidInputBorderColor)
            await expect(signUpPopup.lastNameInputErrorMessage).toHaveText(signUpPopup.lastNameRequiredMessage)
            await expect(signUpPopup.lastNameInputErrorMessage).toBeVisible()
        })
        test('Check that last name can not be less than 2 characters', async ()=> {
            ...
            await expect(signUpPopup.repeatPasswordInput).not.toHaveClass(/is-invalid/)
            await expect(signUpPopup.repeatPasswordInput).not.toHaveCSS('border-color', signUpPopup.invalidInputBorderColor)
            await expect(signUpPopup.lastNameInputErrorMessage).toHaveText(signUpPopup.lastNameWrongLengthMessage)
            await expect(signUpPopup.lastNameInputErrorMessage).toBeVisible()
        })
        ...
        test('Check that last name can not have spaces', async ()=> {
            ...
            await expect(signUpPopup.repeatPasswordInput).not.toHaveClass(/is-invalid/)
            await expect(signUpPopup.repeatPasswordInput).not.toHaveCSS('border-color', signUpPopup.invalidInputBorderColor)
            await expect(signUpPopup.lastNameInputErrorMessage).toHaveText(signUpPopup.lastNameInvalidMessage)
            await expect(signUpPopup.lastNameInputErrorMessage).toBeVisible()
            })
        ...
        test('Check that email field is required', async ()=> {
            ...
            await expect(signUpPopup.repeatPasswordInput).not.toHaveClass(/is-invalid/)
            await expect(signUpPopup.repeatPasswordInput).not.toHaveCSS('border-color', signUpPopup.invalidInputBorderColor)
            await expect(signUpPopup.emailInputErrorMessage).toHaveText(signUpPopup.emailRequiredMessage)
            await expect(signUpPopup.emailInputErrorMessage).toBeVisible()
            })
        test('Check that email field does not accept invalid email', async ()=> {
            ...
            await expect(signUpPopup.repeatPasswordInput).not.toHaveClass(/is-invalid/)
            await expect(signUpPopup.repeatPasswordInput).not.toHaveCSS('border-color', signUpPopup.invalidInputBorderColor)
            await expect(signUpPopup.emailInputErrorMessage).toHaveText(signUpPopup.emailInvalidMessage)
            await expect(signUpPopup.emailInputErrorMessage).toBeVisible()
            })
        ...
        test('Check that password field is required', async ()=> {
            ...
            await expect(signUpPopup.repeatPasswordInput).not.toHaveClass(/is-invalid/)
            await expect(signUpPopup.repeatPasswordInput).not.toHaveCSS('border-color', signUpPopup.invalidInputBorderColor)
            await expect(signUpPopup.passwordInputErrorMessage).toHaveText(signUpPopup.passwordRequiredMessage)
            await expect(signUpPopup.passwordInputErrorMessage).toBeVisible()
            })
        test('Check that password can not be less than 8 characters', async ()=> {
            ...
            await expect(signUpPopup.repeatPasswordInput).not.toHaveClass(/is-invalid/)
            await expect(signUpPopup.repeatPasswordInput).not.toHaveCSS('border-color', signUpPopup.invalidInputBorderColor)
            await expect(signUpPopup.passwordInputErrorMessage).toHaveText(signUpPopup.passwordWrongLengthMessage)
            await expect(signUpPopup.passwordInputErrorMessage).toBeVisible()
            })
        ...
        test('Check that Re-enter password field is required', async ()=> {
            ...
            await expect(signUpPopup.repeatPasswordInputErrorMessage).toHaveText(signUpPopup.repeatPasswordRequiredMessage)
            await expect(signUpPopup.repeatPasswordInputErrorMessage).toBeVisible()
            })
        test('Check that Re-enter password should match with password', async ()=> {
            ...
            await expect(signUpPopup.repeatPasswordInput).toHaveClass(/is-invalid/)
            await expect(signUpPopup.repeatPasswordInput).toHaveCSS('border-color', signUpPopup.invalidInputBorderColor)
            await expect(signUpPopup.repeatPasswordInputErrorMessage).toHaveText(signUpPopup.repeatPasswordDoNotMatchMessage)
            await expect(signUpPopup.repeatPasswordInputErrorMessage).toBeVisible()
            })
    })
})